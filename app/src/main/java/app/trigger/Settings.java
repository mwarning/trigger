...
public class Settings {
    ...
    private static void upgradeDB() {
        ...
        if (Arrays.asList("1.9.2", "2.0.0", "2.0.1", "2.0.2", "2.0.3", "2.0.4", "2.0.5",
                ...
                "2.2.5", "3.0.0", "3.0.1", "3.1.0", "3.1.1").contains(db_version)) {
            Log.i("Settings", "Update database format from " + db_version + " to 3.1.2");
            // nothing to change
            setups = new ArrayList();
            sharedPreferences.edit().putString("db_version", "3.1.2").commit();
            db_version = "3.1.2";
        }
    }
