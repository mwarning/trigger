...
public class Settings {
    ...
    private static void upgradeDB() {
        ...
        if (Arrays.asList("1.9.2", "2.0.0", "2.0.1", "2.0.2", "2.0.3", "2.0.4", "2.0.5",
                ...
                "3.2.1").contains(db_version)) {
            String new_version = "3.2.2";
        ...
        if (Arrays.asList("3.3.6").contains(db_version)) {
        ...
        if (Arrays.asList("3.4.0").contains(db_version)) {
            String new_version = "3.4.1";
            Log.i(TAG, "Update database format from " + db_version + " to " + new_version);
            setups = new ArrayList();
        ...
        if (Arrays.asList("3.4.1", "3.4.2", "3.4.3").contains(db_version)) {
            String new_version = "3.4.4";
            Log.i(TAG, "Update database format from " + db_version + " to " + new_version);
            // nothing to change
            setups = new ArrayList();
            sharedPreferences.edit().putString("db_version", new_version).commit();
